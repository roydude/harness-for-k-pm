...
from paths import DATA_DIR, ROOT_SCRIPTS_DIR, SKILL_ROOT, SOURCE_SCRIPTS_DIR, SRC_ROOT, TEMPLATES_DIR

# ============ CONFIGURATION ============
# Resource paths are centralized so skill-root wrappers can delegate into src/ui-ux-pro-max.
MAX_RESULTS = 3
