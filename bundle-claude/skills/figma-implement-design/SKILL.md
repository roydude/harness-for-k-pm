...
1. Add the Figma MCP:
   - Configure the Figma MCP server in Claude Code.
2. Enable remote MCP client:
   - Ensure Claude Code is configured to allow the Figma MCP connection.
3. Log in with OAuth:
   - Authenticate the Figma MCP server from Claude Code.
